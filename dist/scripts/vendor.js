!(function (e, t) {
    ...
    E = {
      ...
      z: function (e) {
        var t = -e.utcOffset(),
          ...
          s = Math.floor(n / 60),
          o = n % 60;
        return (t <= 0 ? "+" : "-") + f(s, 2, "0") + ":" + f(o, 2, "0");
      },
      m: function e(t, s) {
        if (t.date() < s.date()) return -e(s, t);
        var i = 12 * (s.year() - t.year()) + (s.month() - t.month()),
          o = t.clone().add(i, n),
          a = s - o < 0,
          r = t.clone().add(i + (a ? -1 : 1), n);
        return +(-(i + (s - o) / (a ? o - r : r - o)) || 0);
      },
      a: function (e) {
      ...
      p: function (e) {
        return (
          { M: n, y: o, w: h, d: s, D: a, h: r, m: c, s: l, ms: p, Q: w }[e] ||
          String(e || "")
            .toLowerCase()
            .replace(/s$/, "")
        );
  ...
  return (
    ...
    (e.i = g),
    (e.w = function (e, n) {
      return t(e, { locale: n.$L, utc: n.$u, x: n.$x, $offset: n.$offset });
    }),
    (d = (function () {
      function u(e) {
      ...
      return (
        (d.parse = function (t) {
          (this.$d = (function (t) {
            ...
            return null === s
              ...
              : s instanceof Date
              ? new Date(s)
              : "string" == typeof s && !/Z$/i.test(s) && ((n = s.match(C)), n)
              ? ((o = n[2] - 1 || 0),
        ...
        (d.isSame = function (e, n) {
          var s = t(e);
          return this.startOf(n) <= s && s <= this.endOf(n);
        }),
        (d.isAfter = function (e, n) {
          return t(e) < this.startOf(n);
        }),
        (d.isBefore = function (e, n) {
          return this.endOf(n) < t(e);
        }),
        (d.$g = function (t, n, s) {
          return e.u(t) ? this[n] : this.set(s, t);
        }),
        (d.unix = function () {
        ...
        (d.startOf = function (t, i) {
          var b,
            ...
            m = function (t, n) {
              var o = e.w(
                d.$u ? Date.UTC(d.$y, n, t) : new Date(d.$y, n, t),
                d,
              );
              return u ? o : o.endOf(s);
            },
            f = function (t, n) {
              return e.w(
                d
        ...
        (d.$set = function (t, i) {
          var d,
            ...
            (d[p] = u + "Milliseconds"),
            d)[m],
            g = m === s ? this.$D + (i - this.$W) : i;
          return (
            m === n || m === o
              ? ((h = this.clone().set(a, 1)),
                h.$d[f](g),
                h.init(),
        ...
        (d.add = function (i, a) {
          ...
          var d,
            ...
            f = function (n) {
              var s = t(m);
              return e.w(s.date(s.date() + Math.round(n * i)), m);
            };
          return u === n
            ? this.set(n, this.$M + i)
            : u === o
            ...
            : u === h
            ? f(7)
            : ((p = ((d = {}), (d[c] = v), (d[r] = _), (d[l] = y), d)[u] || 1),
              (g = this.$d.getTime() + i * p),
              e.w(g, this));
        }),
        ...
        (d.format = function (t) {
          ...
          var l = t || "YYYY-MM-DDTHH:mm:ssZ",
            ...
            d = n.months,
            o = function (e, t, n, s) {
              return (e && (e[t] || e(m, l))) || n[t].slice(0, s);
            },
            u = function (t) {
              return e.s(s % 12 || 12, t, "0");
            },
            h =
              n.meridiem ||
              function (e, t, n) {
            ...
            f = {
              ...
              M: a + 1,
              MM: e.s(a + 1, 2, "0"),
              MMM: o(n.monthsShort, a, d, 3),
              MMMM: o(d, a),
              D: this.$D,
              DD: e.s(this.$D, 2, "0"),
              d: String(this.$W),
              dd: o(n.weekdaysMin, this.$W, r, 2),
              ddd: o(n.weekdaysShort, this.$W, r, 3),
              dddd: r[this.$W],
              H: String(s),
              HH: e.s(s, 2, "0"),
              h: u(1),
          ...
          return l.replace(O, function (e, t) {
            return t || f[e] || c.replace(":", "");
          });
        }),
        (d.utcOffset = function () {
          return 15 * -Math.round(this.$d.getTimezoneOffset() / 15);
        }),
        (d.diff = function (i, a, d) {
          var u,
            b = e.p(a),
            p = t(i),
            g = (p.utcOffset() - this.utcOffset()) * v,
            m = this - p,
            f = e.m(this, p);
          return (
            (f =
  ...
  !(function (e, t) {
        ...
        function p(e, t, n) {
          ...
          return (
            ...
            t
              ? i(e * s[o(t)], this)
              : "number" == typeof e
              ? ((this.$ms = e), this.parseFromMilliseconds(), this)
              : "object" == typeof e
              ? (Object.keys(e).forEach(function (t) {
                ...
                this)
              : "string" == typeof e && ((r = e.match(g)), r)
              ? ((a = r.slice(2).map(function (e) {
        ...
        return (
          ...
          (f.parseFromMilliseconds = function () {
            ...
            (this.$d.years = t(e / l)),
              ...
              (this.$d.hours = t(e / r)),
              (e %= r),
              (this.$d.minutes = t(e / u)),
              (e %= u),
              (this.$d.seconds = t(e / h)),
              (e %= h),
              (this.$d.milliseconds = e);
          }),
          (f.toISOString = function () {
            var i = n(this.$d.years, "Y"),
              a = n(this.$d.months, "M"),
              r = +this.$d.days || 0;
            this.$d.weeks && (r += 7 * this.$d.weeks);
            var c = n(r, "D"),
              e = n(this.$d.hours, "H"),
              t = n(this.$d.minutes, "M"),
              l = this.$d.seconds || 0;
            ...
            var s = n(l, "S"),
              d =
                ...
                t.negative ||
                s.negative,
              u = e.format || t.format || s.format ? "T" : "",
              o =
                (d ? "-" : "") +
                "P" +
                i.format +
          ...
          (f.add = function (e, t, n) {
            var r;
            return (
              (r = t ? e * s[o(t)] : a(e) ? e.$ms : i(e, this).$ms),
    ...
    return function (t, n, s) {
      ...
      var o = n.prototype.add,
        r = n.prototype.subtract;
      (n.prototype.add = function (e, t) {
        return a(e) && (e = e.asMilliseconds()), o.bind(this)(e, t);
      }),
        (n.prototype.subtract = function (e, t) {
          return a(e) && (e = e.asMilliseconds()), r.bind(this)(e, t);
        });
    };
  }),
  !(function (e, t) {
    ...
    return function (s, o, i) {
      ...
      (i.utc = function (e) {
        ...
        (d = a.utcOffset),
        (a.utcOffset = function (s, o) {
          if (((a = this.$utils().u), a(s)))
            return this.$u ? 0 : a(this.$offset) ? d.call(this) : this.$offset;
          if (
            "string" == typeof s &&
            ((s = (function (e) {
              if ((void 0 === e && (e = ""), (s = e.match(t)), !s)) return null;
              var s,
                o = ("" + s[0]).match(n) || ["-", 0, 0],
                a = o[0],
                i = 60 * +o[1] + +o[2];
          ...
          var a,
            c,
            r = Math.abs(s) <= 16 ? 60 * s : s,
            i = this;
          return o
            ? ((i.$offset = r), (i.$u = 0 === s), i)
            : (0 !== s
                ? ((c = this.$u
                    ? this.toDate().getTimezoneOffset()
                    : -1 * this.utcOffset()),
                  ((i = this.local().add(r + c, e)).$offset = r),
                  (i.$x.$localOffset = c))
                : (i = this.utc()),
              i);
        }),
 ...
 */ !(function (e, t) {
  ...
  function o(n, o, r) {
    ...
    function l(e, t) {
      e.each(function (e, s) {
        var i = r.data(s, n);
        i ? (i.option(t), i._init()) : ((i = new o(s, t)), r.data(s, n, i));
      });
    }
    (r = r || t || e.jQuery) &&
      (o.prototype.option ||
  ...
  (function (e, t) {
    ...
    return (
      ...
      function (n) {
        ...
        let i = (s.isBorderBox = "border-box" == o.boxSizing);
        e.forEach((e) => {
          let n = o[e],
            t = parseFloat(n);
          s[e] = isNaN(t) ? 0 : t;
        ...
        let a = s.paddingLeft + s.paddingRight,
          r = s.paddingTop + s.paddingBottom,
          ...
          d = t(o.width);
        !1 !== d && (s.width = d + (i ? 0 : a + c));
        let u = t(o.height);
        return (
          !1 !== u && (s.height = u + (i ? 0 : r + l)),
          (s.innerWidth = s.width - (a + c)),
          (s.innerHeight = s.height - (r + l)),
          (s.outerWidth = s.width + h),
    ...
    return (
      (e.on = function (e, t) {
        ...
        let n = (this._events = this._events || {}),
          s = (n[e] = n[e] || []);
        return s.includes(t) || s.push(t), this;
      }),
      (e.once = function (e, t) {
        if (!e || !t) return this;
        this.on(e, t);
  ...
  (function (e, t) {
    ...
    (n.handleEvent = function (e) {
      ...
      "ontouchstart" in e
        ? ((o = "touchstart"), (s = ["touchmove", "touchend", "touchcancel"]))
        : e.PointerEvent
        ? ((o = "pointerdown"),
          (s = ["pointermove", "pointerup", "pointercancel"]))
        : ((o = "mousedown"), (s = ["mousemove", "mouseup"])),
      (n.touchActionValue = "none"),
      ...
      (n.withPointer = function (e, t) {
        t.pointerId == this.pointerIdentifier && this[e](t, t);
      }),
      (n.withTouch = function (e, t) {
        let n;
        for (let e of t.changedTouches)
          e.identifier == this.pointerIdentifier && (n = e);
        n && this[e](t, n);
      }),
    ...
    return (
      (n.pointerDown = function (e, t) {
        let n = a.includes(e.target.nodeName),
          s = r.includes(e.target.type),
          o = !n || s;
        !this.isPointerDown &&
          !e.button &&
          o &&
      ...
      (n.pointerMove = function (e, t) {
        ...
        this.emitEvent("pointerMove", [e, t, n]),
          !this.isDragging && this.hasDragStarted(n) && this.dragStart(e, t),
      ...
      (n.pointerUp = function (e, t) {
        this.pointerDone(),
          ...
          this.isDragging ? this.dragEnd(e, t) : this.staticClick(e, t);
      }),
  ...
  (function (e, t) {
    "object" == typeof module && module.exports
      ? (module.exports = t(e, require("get-size"), require("unidragger")))
      : (e.Draggabilly = t(e, e.getSize, e.Unidragger));
    ...
    let s = (a.prototype = Object.create(n.prototype));
    s.option = function (e) {
    ...
    (s._create = function () {
      ...
      r.includes(e.position) || (this.element.style.position = "relative"),
      ...
      (s.setHandles = function () {
        let { handle: e } = this.options;
        "string" == typeof e
          ? (this.handles = this.element.querySelectorAll(e))
    ...
    const c = ["dragStart", "dragMove", "dragEnd"];
    let l = s.emitEvent;
    function i(e, t, n) {
      return t ? ((n = n || "round"), Math[n](e / t) * t) : e;
    }
    (s.emitEvent = function (t, n) {
      if (!this.isEnabled && c.includes(t)) return;
      l.call(this, t, n);
      let s,
        o = e.jQuery;
      if (!o || !this.$element) return;
      let i = n;
      n && n[0] instanceof Event && ([s, ...i] = n);
      let a = o.Event(s);
      ...
      (s._getPositionCoord = function (e, n) {
        if (e.includes("%")) {
          let s = t(this.element.parentNode);
          return s ? (parseFloat(e) / 100) * s[n] : 0;
        }
      ...
      (s._addTransformPosition = function (e) {
        ...
        let n = t.split(","),
          s = t.startsWith("matrix3d") ? 12 : 4,
          o = parseInt(n[s], 10),
          i = parseInt(n[s + 1], 10);
        (this.position.x += o), (this.position.y += i);
      }),
      (s.handlePointerDown = function (e, t) {
        this.isEnabled &&
      ...
      (s.measureContainment = function () {
        ...
        this.containSize = {
          width: n.width - u - c.x - s.width,
          height: n.height - h - c.y - s.height,
        };
      }),
      ...
      (s.handleDragMove = function (e, t, n) {
        ...
        (s = i(s, r)),
          (o = i(o, c)),
          (s = this.containDrag("x", s, r)),
          (o = this.containDrag("y", o, c)),
          (s = "y" == this.options.axis ? 0 : s),
      ...
      (s.containDrag = function (e, t, n) {
        ...
        let o = "x" == e ? "width" : "height",
          a = i(-this.relativeStartPosition[e], n, "ceil"),
          s = this.containSize[o];
        return (s = i(s, n, "floor")), Math.max(a, Math.min(s, t));
      }),
      ...
      (s.setLeftTop = function () {
        let { x: e, y: t } = this.position;
        (this.element.style.left = `${e}px`),
          (this.element.style.top = `${t}px`);
      }),
      (s.positionDrag = function () {
        let { x: e, y: t } = this.dragPoint;
        this.element.style.transform = `translate3d(${e}px, ${t}px, 0)`;
      }),
    ...
    const d = ["transform", "left", "top", "position"];
    return (
      (s.destroy = function () {
        this.disable(),
          d.forEach((e) => {
  ...
  !(function (e, t) {
    ...
    var n = {
      ...
      s = new ((function () {
        ...
        var t = s.prototype;
        return (
          (t.load = function (t, s, o) {
            if (
              ((t.el = "string" == typeof o ? document.querySelector(o) : o),
              (t.options = e({}, n, s)),
              ...
              var i,
                c,
                a = Array.prototype.slice.apply(t.stringsElement.children),
                r = a.length;
              if (r)
                for (i = 0; i < r; i += 1)
                  t.strings.push(a[i].innerHTML.trim());
            }
            for (c in ((t.strPos = 0),
        ...
        return (
          (t.typeHtmlChars = function (e, t, n) {
            ...
            if ("<" === s || "&" === s) {
              for (
                o = "<" === s ? ">" : ";";
                e.substring(t + 1).charAt(0) !== o && !(1 + ++t > e.length);
          ...
          (t.backSpaceHtmlChars = function (e, t, n) {
            ...
            if (">" === s || ";" === s) {
              for (
                o = ">" === s ? "<" : "&";
                e.substring(t - 1).charAt(0) !== o && !(--t < 0);
    ...
    return (function () {
      ...
      return (
        ...
        (e.typewrite = function (e, n) {
          ...
          var s,
            i = this.humanizer(this.typeSpeed),
            o = 1;
          !0 !== this.pause.status
            ? (this.timeout = setTimeout(function () {
                n = t.typeHtmlChars(e, n, s);
                var a,
                  r = 0,
                  i = e.substring(n);
                if (
                  ("^" === i.charAt(0) &&
                    ...
                    (e = e.substring(0, n) + e.substring(n + a)),
                    s.toggleBlinking(!0)),
                  "`" === i.charAt(0))
                ) {
                  for (
                    ;
                    "`" !== e.substring(n + o).charAt(0) &&
                    (o++, !(n + o > e.length));

                  );
                  var c = e.substring(0, n),
                    l = e.substring(c.length + 1, n + o),
                    d = e.substring(n + o + 1);
                  (e = c + l + d), o--;
                }
                s.timeout = setTimeout(function () {
                  s.toggleBlinking(!1),
                    n >= e.length ? s.doneTyping(e, n) : s.keepTyping(e, n, o),
                    s.temporaryPause &&
                      ((s.temporaryPause = !1),
                      s.options.onTypingResumed(s.arrayPos, s));
                }, r);
              }, i))
            : this.setPauseStatus(e, n, !0);
        }),
        (e.keepTyping = function (e, t, n) {
          0 === t &&
        ...
        (e.backspace = function (e, n) {
          var o,
            s = this;
          if (!0 !== this.pause.status) {
            if (this.fadeOut) return this.initFadeOut();
            this.toggleBlinking(!1),
              (o = this.humanizer(this.backSpeed)),
              (this.timeout = setTimeout(function () {
                n = t.backSpaceHtmlChars(e, n, s);
                var o,
                  i = e.substring(0, n);
                (s.replaceText(i), s.smartBackspace) &&
                  ((o = s.strings[s.arrayPos + 1]),
                  (s.stopNum = o && i === o.substring(0, n) ? n : 0)),
                  n > s.stopNum
                    ? (n--, s.backspace(e, n))
                    : n <= s.stopNum &&
                      (s.arrayPos++,
                      s.arrayPos === s.strings.length
                        ? ((s.arrayPos = 0),
                          ...
                          s.begin())
                        : s.typewrite(s.strings[s.sequence[s.arrayPos]], n));
              }, o));
          } else this.setPauseStatus(e, n, !1);
        }),
        (e.complete = function () {
          this.options.onComplete(this),
            this.loop ? this.curLoop++ : (this.typingComplete = !0);
        }),
        (e.setPauseStatus = function (e, t, n) {
          (this.pause.typewrite = n),
            (this.pause.curString = e),
            (this.pause.curStrPos = t);
        }),
        (e.toggleBlinking = function (e) {
          this.cursor &&
            (this.pause.status ||
  ...
  (function (e) {
    ...
    var u = Object.defineProperty,
      ...
      c = (e, t, n) =>
        t in e
          ...
          : (e[t] = n),
      s = (e, t) => {
        for (var n in t || (t = {})) h.call(t, n) && c(e, n, t[n]);
    ...
    const o = (e = "always") => ({
        ...
        glitchTimeSpan:
          e === "always" ? { start: 0.5, end: 0.7 } : { start: 0, end: 1 },
      ...
      r = (e, t) => {
        ...
        const n = e.glitchTimeSpan.start,
          s = e.glitchTimeSpan.end;
        if (t < n || t > s) return 0;
        const o = n + (s - n) / 2;
        return t < o ? (t - n) / (o - n) : (s - t) / (s - o);
      },
      t = (e, t) => (Math.random() - 0.5) * 2 * r(e, t),
      m = ({ minHeight: e, maxHeight: t, minWidth: n, maxWidth: s }) => {
        const a = Math.floor(Math.random() * ((t - e) * 100 + 1)) + e * 100,
          r = Math.floor(Math.random() * ((s - n) * 100 + 1)) + n * 100,
          ...
          d = `${i}% ${o + a}%`,
          u = `${i}% ${o}%`;
        return `polygon(${c},${l},${d},${u})`;
      },
      f = (e) => {
        const n = Math.floor((e.slice.velocity * e.timing.duration) / 1e3) + 1,
          o = [];
        for (let s = 0; s < n; ++s) {
          if (r(e, s / n) === 0) {
            o.push({ opacity: "0", transform: "none", clipPath: "unset" });
            continue;
          }
          const a = t(e, s / n) * 30,
            i = {
          ...
          e.slice.hueRotate &&
            (i.filter = `hue-rotate(${Math.floor(t(e, s / n) * 360)}deg)`),
            o.push(i);
        }
        return {
          steps: o,
          timing: s({ easing: `steps(${n},jump-start)` }, e.timing),
        };
      },
      p = (e) =>
        e.pulse
      ...
      g = (e) => {
        ...
        const n = Math.floor((e.shake.velocity * e.timing.duration) / 1e3) + 1,
          o = [];
        for (let s = 0; s < n; ++s) {
          const i = t(e, s / n) * e.shake.amplitudeX * 100,
            a = t(e, s / n) * e.shake.amplitudeY * 100;
          o.push({ transform: `translate3d(${i}%,${a}%,0)` });
        }
        return {
          steps: o,
          timing: s({ easing: `steps(${n},jump-start)` }, e.timing),
      ...
      i = (e) =>
        [
          g(e),
          p(e),
          ...Array.from({ length: e.slice.count }).map(() => f(e)),
        ].filter((e) => e !== null),
      n = (...e) => {
        ...
        if (!e.dataset.glitched) {
          ...
          return (
            getComputedStyle(e)
              ...
              .match(/^inline/) && (t.style.display = "inline-block"),
            t.appendChild(n),
            (s = e.parentElement) == null || s.insertBefore(t, e),
            n.prepend(e),
            { container: t, layersContainer: n, glitched: e }
          );
        }
        const n = e.parentElement,
          i = (o = e.parentElement) == null ? void 0 : o.parentElement;
        for (var s, o; n.children.length > 1; ) n.removeChild(n.children[1]);
        return (
          n.firstElementChild.getAnimations().forEach((e) => e.cancel()),
          { container: i, layersContainer: n, glitched: e }
        );
      },
      y = (e, t, n) => {
        const { glitched: r, container: s, layersContainer: i } = j(e, n);
        (i.style.display = "grid"),
          n.hideOverflow && (s.style.overflow = "hidden"),
          n.html && (r.innerHTML = n.html),
          (r.style.gridArea = "1/1/-1/-1");
        const o = r.cloneNode(!0);
        (o.style.gridArea = "1/1/-1/-1"),
        ...
        const a = () => {
            t.forEach((e, t) => {
              i.children[t].animate(e.steps, e.timing);
            });
          },
          c = () => {
            t.forEach((e, t) => {
              i.children[t].getAnimations().forEach((e) => {
                e.cancel();
              });
            });
          };
        switch (
          ...
          case "always":
            ...
            break;
          case "hover":
            (s.onmouseenter = a), (s.onmouseleave = c);
            break;
          case "click":
            s.onclick = () => {
              c(), a();
        ...
        return (
          ...
          { container: s, startGlitch: a, stopGlitch: c }
        );
      },
      _ = {
        glitch: (e = ".powerglitch", t = {}) => {
          const r = n(o(t.playMode), t);
          let s = [];
          typeof e == "string"
